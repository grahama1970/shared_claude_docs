...
"""
Module: youtube_sparta_interaction.py
...
Example Usage:
>>> from youtube_sparta_interaction import YouTubeSpartaPipelineScenario
...
class YouTubeSpartaPipelineScenario(BaseInteraction):
    """
    ...
    def __init__(self):
        super().__init__(
            module_name="youtube-sparta-pipeline",
            interaction_name="youtube_sparta_pipeline"
        )
