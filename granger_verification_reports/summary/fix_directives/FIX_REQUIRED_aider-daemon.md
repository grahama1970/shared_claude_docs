...
You MUST fix all the issues listed below in the aider-daemon project. This is not optional - these fixes are required for the Granger ecosystem to function properly.
...
## Fix Required: Remove Mock Usage in aider-daemon

**Issue**: Tests are using mocks instead of real system interactions.
**Files**: ['tests/smoke/test_honeypot.py', 'tests/unit/cli/test_session_listing.py', 'tests/unit/cli/test_print_mode.py']

### Required Actions:
1. Navigate to the project: `cd /home/graham/workspace/experiments/aider-daemon`
