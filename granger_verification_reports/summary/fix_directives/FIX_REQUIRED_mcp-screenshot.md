...
You MUST fix all the issues listed below in the mcp-screenshot project. This is not optional - these fixes are required for the Granger ecosystem to function properly.
...
## Fix Required: Remove Mock Usage in mcp-screenshot

**Issue**: Tests are using mocks instead of real system interactions.
**Files**: ['tests/test_batch.py']

### Required Actions:
1. Navigate to the project: `cd /home/graham/workspace/experiments/mcp-screenshot`
