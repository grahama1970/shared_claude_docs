...
You MUST fix all the issues listed below in the granger_hub project. This is not optional - these fixes are required for the Granger ecosystem to function properly.
...
## Fix Required: Remove Mock Usage in granger_hub

**Issue**: Tests are using mocks instead of real system interactions.
**Files**: ['tests/test_self_improvement_system.py', 'tests/cli/test_screenshot_commands.py', 'tests/core/modules/test_screenshot_module.py', 'tests/rl/metrics/test_rl_metrics_mock.py']

### Required Actions:
1. Navigate to the project: `cd /home/graham/workspace/experiments/granger_hub`
