...
if [ $# -eq 0 ]; then
    ...
    echo ""
    echo -e "Stress Tests:"
    echo -e "  10. knowledge_evolution - Iterative learning with feedback loops
  11. model_pipeline   - End-to-end ML workflow coordination
  12. competitive      - Modules compete then collaborate

  13. avalanche         - Cascading failure and recovery"
...
"
    ...
    # New practical scenarios
    knowledge_evolution|knowledge|10)
        check_discovery_service
        run_scenario "Knowledge Evolution" "knowledge_evolution_scenario.py" "creative"
        ;;
    
    model_pipeline|pipeline|11)
        check_discovery_service
        run_scenario "Model Training Pipeline" "model_training_pipeline_scenario.py" "creative"
        ;;
    
    competitive|compete|12)
        ;;
    
    # Gemini-inspired scenarios
    research_consensus|consensus|13)
        check_discovery_service
        run_scenario "Research Consensus Engine" "research_consensus_scenario.py" "creative"
        ;;
    
    dynamic_explorer|explorer|14)
        check_discovery_service
        run_scenario "Dynamic Knowledge Explorer" "dynamic_explorer_scenario.py" "creative"
        ;;
    
    training_pipeline|pipeline|15)
        check_discovery_service
        run_scenario "Research to Training Pipeline" "research_training_pipeline_scenario.py" "creative"
        check_discovery_service
