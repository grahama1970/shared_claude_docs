...
This template provides the standard implementation pattern for MCP prompts.
...
# Replace 'template' with your project name throughout this file
PROJECT_NAME = "template"
PROJECT_DESCRIPTION = "Template project for Granger ecosystem"
